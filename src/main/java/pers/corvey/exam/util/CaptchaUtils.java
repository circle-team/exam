...
public class CaptchaUtils {
    ...
    private static final int NUM_OF_LINES = 5; // 干扰线数量
    
    private static final double NOISE_PERCENT = 0.01;   // 噪点占比
    
    private static final int MAX_ANGEL_OF_ROTATION = 30;    // 字体倾斜角度上限

    // 验证码字符集
    private static final char[] CAPTCHA_CHARSET = "1234567890".toCharArray();
